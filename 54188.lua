...
function library.new(library, name, theme)
	...
	local config = {
		...
		Bg_Color = Color3.fromRGB(70, 70, 70),
		Zy_Color = Color3.fromRGB(80, 80, 80),

		Button_Color = Color3.fromRGB(90, 90, 90),
		Textbox_Color = Color3.fromRGB(100, 100, 100),
		Dropdown_Color = Color3.fromRGB(110, 110, 110),
		Keybind_Color = Color3.fromRGB(120, 120, 120),
		Label_Color = Color3.fromRGB(130, 130, 130),

		Slider_Color = Color3.fromRGB(140, 140, 140),
		SliderBar_Color = Color3.fromRGB(37, 254, 152),

		Toggle_Color = Color3.fromRGB(150, 150, 150),
		Toggle_Off = Color3.fromRGB(160, 160, 160),
		Toggle_On = Color3.fromRGB(170, 170, 170),
	}
	...
	Open.Active = true
	Open.Draggable = true
	Open.Image = "rbxassetid://90251498030083"
	...
	function window.Tab(window, name, icon)
		...
		function tab.section(tab, name, TabVal)
			...
			SearchBox.Parent = Section
			SearchBox.BackgroundColor3 = config.Bg_Color
			SearchBox.Position = UDim2.new(0, 6, 0, 0)
			SearchBox.Size = UDim2.new(0.986347735, 0, 0, 30)
			SearchBox.Font = Enum.Font.GothamSemibold
			SearchBox.PlaceholderText = "Search..."
			SearchBox.TextColor3 = Color3.fromRGB(255, 255, 255)
			SearchBox.TextSize = 14.000
			SearchBoxC.CornerRadius = UDim.new(0, 6)
			SearchBoxC.Name = "SearchBoxC"
			SearchBoxC.Parent = SearchBox
			local open = TabVal
			...
			SearchBox:GetPropertyChangedSignal("Text"):Connect(function()
				...
				for _, obj in ipairs(Objs:GetChildren()) do
					if obj:IsA("GuiObject") and obj.Name ~= "SearchBox" then
						local visible = searchText == "" or obj.Name:lower():find(searchText) or obj.Text:lower():find(searchText)
						obj.Visible = visible
					end
				end
			end)
