...
print("用户界面库加载成功！")
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("HE脚本V2")--V1
local creds = window:Tab("关于", "6031097229")
    ...
    bin:Label("会努力更新的")
    bin:Label("也感谢帮我的人")
    bin:Label("作者QQ：3990117600")
    bin:Label("发布日期：2024年12月29号")
...
local creditsxksans = UITab4:section("主要功能",true)

creditsxksans:Toggle("自动举重","text",false,function(s)
toggle = Value
...
creditsxksans:Toggle("自动卖","text",false,function(s)
tog = Value
   while tog do wait()
local ohTable1 = {
	[1] = "SellMuscle"
...
creditsxksans:Button("打开商店",function()
...
local creditsxknb = UITab4:section("功能",true)

creditsxknb:Button("防止微笑感染",function()
...
creditsxknb:Button("取消门",function()
for _,v in pairs(game.workspace:GetDescendants()) do
...
creditsxknb:Button("开启反外挂",function()
workspace.Map.AntiHack:Destroy() game.Players.LocalPlayer.Character.AntiFly:Destroy()
end)
creditsxknb:Toggle("速度-微笑感染","text",false,function(s)
...
creditsxknb:Toggle("打击微笑感染","text",false,function(s)
...
creditsxknb:Toggle("Bat打击","text",false,function(s)
getgenv().HitAura = s
...
creditsxknb:Toggle("瓶子打击","text",false,function(s)
getgenv().HitAura = s
        if getgenv().HitAura then
            getgenv().HitAuraConnection = game:GetService("RunService").Stepped:Connect(function()
                pcall(function()
...
local creditskknb = UITab4:section("功能",true)

creditskknb:Toggle("地图投票界面", "Map Voting UI", false, function(bool)
...
creditskknb:Toggle("开启游戏岛悬崖碰撞体积", "Togglelnfo", false, function(bool)
...
creditskknb:Toggle("在水上行走", "ToggleInfo", false, function(bool)
...
creditskknb:Toggle("自动存活", "ToggleInfo", false, function(bool)
    _G.autowinfarm = bool;
    while wait(.1) do
...
local credits = UITab4:section("『力量传奇』",true)
