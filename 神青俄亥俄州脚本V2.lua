game:GetService("StarterGui"):SetCore("SendNotification",{ 
     Title = "反挂机 已经为您打开", 
     Text = "感谢支持", 
     Icon = "rbxassetid://77240230517276", 
     Duration = 60, 
     Callback = bindable, 
     Button1 = "谢谢", 
     Button2 = "关闭" 
...
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/gycgchgyfytdttr/shenqin/refs/heads/main/shinqine.lua"))()        
local win = ui:new("神青俄亥俄州V2")
...
about:Button(
  ...
  local a=game:GetService("Players")local b=a.LocalPlayer;local c=Instance.new("ScreenGui")c.Parent=b:WaitForChild("PlayerGui")c.Name="TPGui"c.ResetOnSpawn=false;local d=Instance.new("Frame")d.Parent=c;d.Size=UDim2.new(0,200,0,300)d.Position=UDim2.new(0,10,0,10)d.BackgroundColor3=Color3.fromRGB(50,50,50)d.BorderSizePixel=0;d.Active=true;d.Draggable=true;d.Visible=true;local e=Instance.new("TextLabel")e.Parent=d;e.Size=UDim2.new(1,0,0,50)e.BackgroundColor3=Color3.fromRGB(70,70,70)e.Text="TP to Player"e.TextColor3=Color3.new(1,1,1)e.Font=Enum.Font.SourceSans;e.TextSize=20;local f=Instance.new("ScrollingFrame")f.Parent=d;f.Size=UDim2.new(1,0,1,-50)f.Position=UDim2.new(0,0,0,50)f.CanvasSize=UDim2.new(0,0,0,0)f.ScrollBarThickness=8;f.BackgroundColor3=Color3.fromRGB(40,40,40)local function g()f:ClearAllChildren()local h=0;for i,j in ipairs(a:GetPlayers())do if j~=b then local k=Instance.new("TextButton")k.Parent=f;k.Size=UDim2.new(1,-10,0,30)k.Position=UDim2.new(0,5,0,h)k.Text=j.Name;k.BackgroundColor3=Color3.fromRGB(60,60,60)k.TextColor3=Color3.new(1,1,1)k.Font=Enum.Font.SourceSans;k.TextSize=18;h=h+35;k.MouseButton1Click:Connect(function()local l=j.Character;if l and l:FindFirstChild("HumanoidRootPart")then local m=l.HumanoidRootPart;local n=m.CFrame.LookVector;b.Character.HumanoidRootPart.CFrame=m.CFrame-n*2+Vector3.new(0,0.5,0)end end)end end;f.CanvasSize=UDim2.new(0,0,0,h)end;a.PlayerAdded:Connect(g)a.PlayerRemoving:Connect(g)g()local o=Instance.new("TextButton")o.Parent=c;o.Size=UDim2.new(0,50,0,50)o.Position=UDim2.new(0,44,0,435)o.BackgroundColor3=Color3.fromRGB(100,100,255)o.Text="TP"o.TextColor3=Color3.new(1,1,1)o.Font=Enum.Font.SourceSansBold;o.TextSize=18;o.BorderSizePixel=0;o.Active=true;o.ClipsDescendants=true;o.AnchorPoint=Vector2.new(0,0)local p=Instance.new("UICorner")p.CornerRadius=UDim.new(1,0)p.Parent=o;o.MouseButton1Click:Connect(function()d.Visible=not d.Visible end)
    ...
    about:Button(
        "防踢出",
        function()
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="已开启"; Duration = 2; })wait("3") 
...
end)   about:Button("远程保险", "insurance", false, function(Value)
...
local UITab84 = win:Tab("自动功能",'16060333448')
...
about:Button("银行里面",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1087.274658203125, 8.169801712036133, -343.4639587402344)
            tp2.CFrame = tp3
end)

about:Button("银行外面",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1084.5325927734375, 6.2468485832214355, -425.96929931640625)
            tp2.CFrame = tp3
end)

about:Button("珠宝店外面",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1546.2052001953125, 6.245292663574219, -684.1364135742188)
            tp2.CFrame = tp3
end)

about:Button("珠宝店里面",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1718.9903564453125, 14.272229194641113, -725.5169067382812)
            tp2.CFrame = tp3
end)
...
about:Button("警察局",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(683.267578125, 6.245400428771973, -904.3998413085938)
            tp2.CFrame = tp3
end)

about:Button("军事基地",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(804.9326171875, 25.265623092651367, -1331.7320556640625)
            tp2.CFrame = tp3
end)

about:Button("军事基旁武器店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1119.950927734375, 25.343891143798828, -1308.7613525390625)
            tp2.CFrame = tp3
end)

about:Button("警察局旁武器店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(670.1553344726562, 6.245391845703125, -658.22802734375)
            tp2.CFrame = tp3
end)

about:Button("珠宝店旁武器店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1547.314697265625, 6.24489164352417, -608.4329223632812)
            tp2.CFrame = tp3
end)

about:Button("加油站",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1072.2225341796875, 6.045392990112305, -616.2798461914062)
            tp2.CFrame = tp3
end)
...
about:Button("医院",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1073.444091796875, 6.0453948974609375, -968.4043579101562)
            tp2.CFrame = tp3
end)

about:Button("买气球和摇摇乐",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(834.3544921875, 6.245891094207764, -935.71044921875)
            tp2.CFrame = tp3
end)

about:Button("电话店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(882.4231567382812, 6.246849060058594, -1023.138671875)
            tp2.CFrame = tp3
end)
...
about:Button("家具店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(971.3882446289062, 6.2458648681640625, -783.7587890625)
            tp2.CFrame = tp3
end)

about:Button("家具店2",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(390.9602966308594, -6.0471086502075195, -384.566162109375)
            tp2.CFrame = tp3
end)

about:Button("夜店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1525.67529296875, 6.24489164352417, -785.3524780273438)
            tp2.CFrame = tp3
end)

about:Button("消防站",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1572.544921875, 6.245391845703125, -514.4601440429688)
            tp2.CFrame = tp3
end)

about:Button("咖啡馆",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1278.8885498046875, 6.245991230010986, -331.8045959472656)
            tp2.CFrame = tp3
end)

about:Button("汉堡店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1339.9090576171875, 6.044891357421875, -660.3264770507812)
            tp2.CFrame = tp3
end)

about:Button("杂货店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(952.1937866210938, 6.245891094207764, -930.346435546875)
            tp2.CFrame = tp3
end)

about:Button("剧院",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(532.3129272460938, 6.045393466949463, -978.8245239257812)
            tp2.CFrame = tp3
end)

about:Button("披萨店",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(399.05078125, 6.2438507080078125, -878.3633422851562)
            tp2.CFrame = tp3
end)

about:Button("摩天轮",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1152.4921875, 16.618755340576172, 16.511913299560547)
            tp2.CFrame = tp3
end)

about:Button("教堂",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1456.5350341796875, 5.239261150360107, -35.529232025146484)
            tp2.CFrame = tp3
end)

about:Button("滑板公园",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1552.9686279296875, 6.245391845703125, -218.27784729003906)
            tp2.CFrame = tp3
end)
...
about:Button("健身房",function()
            local tp1 = game:GetService("Players")
            local tp2 = tp1.LocalPlayer.Character.HumanoidRootPart
            local tp3 = CFrame.new(1559.5380859375, 6.246891021728516, -317.7867126464844)
            tp2.CFrame = tp3
end)
