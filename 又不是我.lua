...
function library.new(library, name, theme)
	...
	local config = {
		...
		Zy_Color = Color3.fromRGB(50, 50, 50),

		Button_Color = Color3.fromRGB(60, 60, 60),
		Textbox_Color = Color3.fromRGB(60, 60, 60),
		Dropdown_Color = Color3.fromRGB(60, 60, 60),
		Keybind_Color = Color3.fromRGB(60, 60, 60),
		Label_Color = Color3.fromRGB(60, 60, 60),

		Slider_Color = Color3.fromRGB(60, 60, 60),
		SliderBar_Color = Color3.fromRGB(0, 255, 255),

		Toggle_Color = Color3.fromRGB(60, 60, 60),
	...
	function window.Tab(window, name, icon)
		...
		SearchBox.Size = UDim2.new(0.986347735, 0, 0, 28)
		...
		local function filterContent(searchText)
			for _, element in ipairs(Tab:GetChildren()) do
				if element:IsA("Frame") then
					local visible = false
					for _, child in ipairs(element:GetChildren()) do
						if child:IsA("TextLabel") and child.Text:lower():find(searchText:lower()) then
							visible = true
							break
						end
					end
		...
		function tab.section(tab, name, TabVal)
			...
			function section.Dropdown(section, text, flag, options, callback)
				...
				local searchDropdown = function(text)
					for _, option in ipairs(DropdownModule:GetChildren()) do
						if text == "" then
							...
							if option:IsA("TextButton") and option.Name:match("Option_") then
								if option.Text:lower():find(text:lower()) then
									option.Visible = true
								else
				...
				funcs.RemoveOption = function(self, option)
					local optionInstance = DropdownModule:FindFirstChild("Option_" .. option)
					if optionInstance then
