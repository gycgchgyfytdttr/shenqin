...
local redzlib = {
	...
	Flags = {},
	Tabs = {},
	Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/gycgchgyfytdttr/shenqin/refs/heads/main/REDzIcon%20(1).txt"))()
}
...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("安脚本.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
	...
	local CloseButton = Create("ImageButton", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://77240230517276",
		AutoButtonColor = false,
		Name = "Close"
	})
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			MinimizeButton.Image = "rbxassetid://77240230517276"
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDropdown(Configs)
			...
			local function Disable()
				...
				Arrow.Image = "rbxassetid://77240230517276"
